; ModuleID = 'cminus'
source_filename = "/home/archer/cplabs/2023ustc-jianmu-compiler/tests/3-codegen/autogen/testcases/12-global.cminus"
...
label5:                                                ; preds = %label2
  ...
  br i1 %op7, label %label9, label %label17
label8:                                                ; preds = %label2
  ret i32 20
label9:                                                ; preds = %label5
...
label12:                                                ; preds = %label9, %label17
  ...
  br i1 %op16, label %label20, label %label22
